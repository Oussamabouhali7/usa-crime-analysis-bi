...
--
-- Hôte : 127.0.0.1
-- Généré le : mar. 01 juin 2021 à 22:59
...
--
-- Base de données : `projet_mmed`
--

-- --------------------------------------------------------

--
-- Structure de la table `population_by_state`
--

CREATE TABLE `population_by_state` (
  `Rank` int(11) NOT NULL,
  `State` varchar(30) NOT NULL,
  `July 2019 Estimate` varchar(20) NOT NULL,
  `Percent of Total` varchar(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Déchargement des données de la table `population_by_state`
--

INSERT INTO `population_by_state` (`Rank`, `State`, `July 2019 Estimate`, `Percent of Total`) VALUES
